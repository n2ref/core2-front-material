...
<head>
    ...
    <link rel="stylesheet" href="core2/html/material/css/styles.css?_=38" type="text/css"/>
    ...
    <script type="text/javascript" src="core2/html/material/js/coreui.table.js?_=17"></script>
